...
export const metadata: Metadata = {
  title: "Kelley v. Commonwealth | Virginia Assault & Battery Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2011) — Whether the jury instructions correctly defined the intent element of assault an.... D.J. Rivera defends Assault & Battery cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Kelley v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Assault & Battery Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Kelley v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the jury instructions correctly defined the intent element of assault and battery.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court found that the jury instructions adequately conveyed the intent requirement for assault and battery. The court clarified that 'general intent' — the intent to do the act that constitutes the offense — is sufficient; specific intent to cause harm is not required.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Virginia assault and battery is a general intent crime — the prosecution need not prove that the defendant specifically intended to harm the victim, only that they intended to make the contact. This makes it critical for defense counsel to challenge the voluntariness of the act itself, or to establish a recognized defense such as self-defense, defense of others, or consent.</p>
          </div>
