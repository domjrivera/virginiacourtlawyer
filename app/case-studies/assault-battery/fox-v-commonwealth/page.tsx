...
export const metadata: Metadata = {
  title: "Fox v. Commonwealth | Virginia Assault & Battery Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2009) — Whether an intentional but non-harmful touching can constitute assault and batte.... D.J. Rivera defends Assault & Battery cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Fox v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Assault & Battery Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Fox v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether an intentional but non-harmful touching can constitute assault and battery under Virginia law.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court held that assault and battery under Virginia law requires an intentional, unlawful touching of another person — but does not require that the touching cause physical injury. The court affirmed the conviction, finding that the defendant's intentional contact, though causing no lasting harm, met the statutory definition.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">The absence of physical injury does not preclude an assault and battery conviction in Virginia. However, this case also reinforces that the touching must be intentional and unlawful — accidental contact, contact made in self-defense, or contact to which the alleged victim consented does not constitute assault and battery. Defense counsel should focus on these elements when the alleged harm is minimal.</p>
          </div>
