...
export const metadata: Metadata = {
  title: "Anderson v. Commonwealth | Virginia Robbery Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2008) — Whether the eyewitness identification of the defendant as the perpetrator of the.... D.J. Rivera defends Robbery cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Anderson v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Robbery Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Anderson v. Commonwealth</h1>
