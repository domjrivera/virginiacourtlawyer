...
export const metadata: Metadata = {
  title: "Wallace v. Commonwealth | Virginia Computer Crimes Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2016) — Whether the defendant's access to a computer system exceeded authorized access u.... D.J. Rivera defends Computer Crimes cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Wallace v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Computer Crimes Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Wallace v. Commonwealth</h1>
          <div className="flex flex-wrap gap-4 text-sm text-slate-300">
            <span>📍 Virginia Court of Appeals</span>
            <span>📅 2016</span>
            <span>⚖️ Virginia Code § 18.2-152.3:1</span>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant's access to a computer system exceeded authorized access under § 18.2-152.3:1.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court reversed the conviction, finding that the prosecution failed to prove beyond a reasonable doubt that the defendant knowingly exceeded authorized access. The court held that § 18.2-152.3:1 requires proof of intentional unauthorized access — not merely access that exceeded the scope of authorization in a technical sense.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">The 'exceeds authorized access' theory of computer crime liability is one of the most contested areas of computer law. D.J. Rivera challenges this theory by arguing that the defendant had a legitimate basis for accessing the system and that any excess was inadvertent rather than intentional. His computer engineering background allows him to understand and explain the technical nuances of access authorization to the court.</p>
          </div>

          <div className="border border-slate-200 rounded-2xl p-8">
            <h2 className="text-xl font-semibold text-navy mb-3">Relevant Virginia Law</h2>
            <p className="text-slate-600">This case involves <strong>§ 18.2-152.3:1</strong> of the Virginia Code. For a full analysis of how this statute applies to your case, consult with D.J. Rivera.</p>
          </div>
        </div>
