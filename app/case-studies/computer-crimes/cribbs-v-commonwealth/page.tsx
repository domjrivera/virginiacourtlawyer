...
export const metadata: Metadata = {
  title: "Cribbs v. Commonwealth | Virginia Computer Crimes Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2013) — Whether the defendant's possession of child pornography on a shared network driv.... D.J. Rivera defends Computer Crimes cases in Richmond and Northern Virginia.",
};

export default function CribbsVCommonwealthCase() {
  return (
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Cribbs v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Computer Crimes Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Cribbs v. Commonwealth</h1>
          <div className="flex flex-wrap gap-4 text-sm text-slate-300">
            <span>📍 Virginia Court of Appeals</span>
            <span>📅 2013</span>
            <span>⚖️ Virginia Code § 18.2-374.1:1</span>
          </div>
        </div>
      </section>
