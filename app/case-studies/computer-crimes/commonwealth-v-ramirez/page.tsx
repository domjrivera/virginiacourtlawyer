...
export const metadata: Metadata = {
  title: "Commonwealth v. Ramirez | Virginia Computer Crimes Defense – D.J. Rivera, Esq.",
  description: "Virginia Circuit Court (2016) — Whether the defendant's use of a VPN to mask his IP address was evidence of cons.... D.J. Rivera defends Computer Crimes cases in Richmond and Northern Virginia.",
};

export default function CommonwealthVRamirezCase() {
  return (
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Commonwealth v. Ramirez</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Computer Crimes Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Commonwealth v. Ramirez</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant's use of a VPN to mask his IP address was evidence of consciousness of guilt.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court held that the use of a VPN, standing alone, is not evidence of consciousness of guilt — VPNs are widely used for legitimate privacy purposes. The court excluded the VPN evidence as unduly prejudicial, finding that its probative value was substantially outweighed by the risk of unfair prejudice.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">The use of privacy tools such as VPNs, encrypted messaging apps, and anonymous browsing is not inherently evidence of criminal intent. D.J. Rivera challenges the prosecution's use of privacy tool evidence in computer crime cases, arguing that these tools are used by millions of people for legitimate privacy purposes.</p>
          </div>
