...
export const metadata: Metadata = {
  title: "Commonwealth v. Murgia | Virginia Computer Crimes Defense – D.J. Rivera, Esq.",
  description: "Virginia Circuit Court (2015) — Whether the defendant's use of a work computer for personal purposes constituted.... D.J. Rivera defends Computer Crimes cases in Richmond and Northern Virginia.",
};

export default function CommonwealthVMurgiaCase() {
  return (
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Commonwealth v. Murgia</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Computer Crimes Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Commonwealth v. Murgia</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant's use of a work computer for personal purposes constituted computer fraud under § 18.2-152.3.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court dismissed the computer fraud charge, finding that the defendant's use of a work computer for personal purposes — while a violation of company policy — did not constitute computer fraud under § 18.2-152.3. The court held that computer fraud requires proof of an intent to defraud or obtain property by false pretenses, not merely unauthorized use.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Not every violation of a computer use policy constitutes a crime. D.J. Rivera challenges computer fraud charges by scrutinizing whether the defendant's conduct involved the intent to defraud or obtain property by false pretenses — distinguishing between criminal computer fraud and mere policy violations.</p>
          </div>
