...
export const metadata: Metadata = {
  title: "Hulcher v. Commonwealth | Virginia Shoplifting Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2010) — Whether the defendant's concealment of merchandise was sufficient to prove the i.... D.J. Rivera defends Shoplifting cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Hulcher v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Shoplifting Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Hulcher v. Commonwealth</h1>
