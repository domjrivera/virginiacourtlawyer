...
export const metadata: Metadata = {
  title: "Woolfolk v. Commonwealth | Virginia Threats & Stalking Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2017) — Whether the defendant's online posts constituted harassment by computer under §.... D.J. Rivera defends Threats & Stalking cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Woolfolk v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Threats & Stalking Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Woolfolk v. Commonwealth</h1>
          <div className="flex flex-wrap gap-4 text-sm text-slate-300">
            <span>📍 Virginia Court of Appeals</span>
            <span>📅 2017</span>
            <span>⚖️ Virginia Code § 18.2-152.7:1</span>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant's online posts constituted harassment by computer under § 18.2-152.7:1.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court affirmed the harassment by computer conviction, finding that the defendant's repeated, offensive posts directed at the alleged victim on a public forum — combined with direct messages — constituted harassment by computer. The court held that harassment by computer does not require that the communications be sent directly to the victim.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Virginia's harassment by computer statute (§ 18.2-152.7:1) is broadly written and has been applied to a wide range of online conduct. D.J. Rivera — with his background in Internet law and computer engineering — is uniquely qualified to defend harassment by computer cases, challenging the attribution of online communications and the application of the statute to the specific conduct alleged.</p>
          </div>

          <div className="border border-slate-200 rounded-2xl p-8">
            <h2 className="text-xl font-semibold text-navy mb-3">Relevant Virginia Law</h2>
            <p className="text-slate-600">This case involves <strong>§ 18.2-152.7:1</strong> of the Virginia Code. For a full analysis of how this statute applies to your case, consult with D.J. Rivera.</p>
          </div>
        </div>
