...
export const metadata: Metadata = {
  title: "Keyes v. Commonwealth | Virginia Threats & Stalking Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2011) — Whether the defendant's repeated contacts with the alleged victim constituted st.... D.J. Rivera defends Threats & Stalking cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Keyes v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Threats & Stalking Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Keyes v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant's repeated contacts with the alleged victim constituted stalking under § 18.2-60.3.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court affirmed the stalking conviction, finding that the defendant's repeated, unwanted contacts — including phone calls, text messages, and physical appearances at the alleged victim's home and workplace — constituted a course of conduct that would cause a reasonable person to suffer substantial emotional distress. The court held that the defendant's intent to cause distress could be inferred from the pattern of conduct.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Stalking requires proof of a course of conduct — two or more acts — that would cause a reasonable person to suffer substantial emotional distress. D.J. Rivera challenges stalking charges by scrutinizing whether the alleged contacts were actually unwanted, whether the alleged victim communicated that the contacts were unwanted, and whether the contacts were sufficient to cause a reasonable person substantial emotional distress.</p>
          </div>
