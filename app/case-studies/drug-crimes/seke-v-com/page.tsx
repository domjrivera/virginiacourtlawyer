...
export const metadata: Metadata = {
  title: "Seke v. Commonwealth | Virginia Drug Crimes Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2014) — Whether the defendant was entitled to a first-offender disposition under Virgini.... D.J. Rivera defends Drug Crimes cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Seke v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Drug Crimes Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Seke v. Commonwealth</h1>
          <div className="flex flex-wrap gap-4 text-sm text-slate-300">
            <span>📍 Virginia Court of Appeals</span>
            <span>📅 2014</span>
            <span>⚖️ Virginia Code § 18.2-251</span>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant was entitled to a first-offender disposition under Virginia Code § 18.2-251.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court held that the defendant was entitled to consideration for a first-offender disposition under § 18.2-251, which allows first-time drug possession offenders to have their charges dismissed upon successful completion of a probationary period. The court reversed the trial court's denial of the first-offender disposition.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Virginia Code § 18.2-251 provides a critical safety valve for first-time drug possession offenders — allowing them to avoid a conviction and keep their record clean. D.J. Rivera pursues first-offender dispositions in every eligible case, protecting clients' employment, housing, and professional licensing prospects.</p>
          </div>

          <div className="border border-slate-200 rounded-2xl p-8">
            <h2 className="text-xl font-semibold text-navy mb-3">Relevant Virginia Law</h2>
            <p className="text-slate-600">This case involves <strong>§ 18.2-251</strong> of the Virginia Code. For a full analysis of how this statute applies to your case, consult with D.J. Rivera.</p>
          </div>
        </div>
