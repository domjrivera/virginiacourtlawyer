...
export const metadata: Metadata = {
  title: "Kelly v. Commonwealth | Virginia Drug Crimes Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2012) — Whether the defendant's statement to police was admissible where the defendant c.... D.J. Rivera defends Drug Crimes cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Kelly v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Drug Crimes Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Kelly v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant's statement to police was admissible where the defendant claimed it was made involuntarily.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court suppressed the statement, finding that the totality of the circumstances — including the length of the interrogation, the defendant's fatigue, and the officers' promises of leniency — rendered the statement involuntary. The court held that a statement is involuntary if it is the product of coercion, threats, or promises that overbear the defendant's will.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Involuntary confessions are inadmissible under the Due Process Clause. D.J. Rivera scrutinizes the circumstances of every client statement to police — including the length and conditions of interrogation, whether Miranda rights were properly given, and whether any promises or threats were made — and moves to suppress statements that were not freely and voluntarily given.</p>
          </div>
