...
export const metadata: Metadata = {
  title: "Howard v. Commonwealth | Virginia Drug Crimes Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2009) — Whether the evidence was sufficient to prove possession with intent to distribut.... D.J. Rivera defends Drug Crimes cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Howard v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Drug Crimes Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Howard v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the evidence was sufficient to prove possession with intent to distribute (PWID) rather than simple possession.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court affirmed the PWID conviction, finding that the quantity of drugs, the presence of packaging materials, scales, and cash, and the absence of drug paraphernalia for personal use were sufficient to prove intent to distribute beyond a reasonable doubt.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">The distinction between simple possession and PWID is critical — PWID carries dramatically higher penalties. The prosecution relies on circumstantial evidence of intent, including drug quantity, packaging, scales, and cash. D.J. Rivera challenges the sufficiency of this circumstantial evidence and works to have PWID charges reduced to simple possession where the evidence of intent is weak.</p>
          </div>
