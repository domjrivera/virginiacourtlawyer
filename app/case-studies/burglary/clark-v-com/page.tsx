...
export const metadata: Metadata = {
  title: "Clark v. Commonwealth | Virginia Burglary Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2008) — Whether the defendant had the intent to commit a felony at the time of entry, as.... D.J. Rivera defends Burglary cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Clark v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Burglary Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Clark v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant had the intent to commit a felony at the time of entry, as required for burglary.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court reversed the burglary conviction, finding that the prosecution failed to prove beyond a reasonable doubt that the defendant had the intent to commit a felony at the time of entry. The court held that intent to commit a felony must exist at the moment of entry — intent formed after entry is insufficient for burglary.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Burglary requires proof of intent to commit a felony at the time of entry — not merely after entry. This is a critical distinction that can reduce a burglary charge to the lesser offense of unlawful entry. D.J. Rivera challenges the timing and nature of the alleged intent in every burglary case.</p>
          </div>
