...
export const metadata: Metadata = {
  title: "Saunders v. Commonwealth | Virginia Firearms & Weapons Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2013) — Whether the search of the defendant's vehicle that revealed the firearm was lawf.... D.J. Rivera defends Firearms & Weapons cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Saunders v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Firearms & Weapons Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Saunders v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the search of the defendant's vehicle that revealed the firearm was lawful.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court suppressed the firearm, finding that the officer lacked probable cause to search the vehicle. The court held that the officer's observation of a bulge under the defendant's seat — without more — did not provide probable cause to believe the vehicle contained contraband or evidence of a crime.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Fourth Amendment suppression is the most powerful tool in firearms cases. If the firearm was discovered during an unlawful search, it must be suppressed — and without the firearm, the charge cannot stand. D.J. Rivera files suppression motions in every firearms case where the search may have been unlawful.</p>
          </div>
