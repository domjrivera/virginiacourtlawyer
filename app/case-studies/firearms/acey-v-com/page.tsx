...
export const metadata: Metadata = {
  title: "Acey v. Commonwealth | Virginia Firearms & Weapons Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2009) — Whether the defendant's prior felony conviction disqualified him from possessing.... D.J. Rivera defends Firearms & Weapons cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Acey v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Firearms & Weapons Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Acey v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the defendant's prior felony conviction disqualified him from possessing a firearm under § 18.2-308.2.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court affirmed the conviction, finding that the defendant's prior felony conviction was properly established and that the defendant knowingly possessed the firearm. The court held that the prosecution need not prove the defendant knew his prior conviction disqualified him from possessing firearms.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Felon in possession cases turn on two issues: (1) whether the prior conviction qualifies as a disqualifying felony, and (2) whether the defendant actually possessed the firearm. D.J. Rivera challenges both elements — scrutinizing the prior conviction record and challenging the evidence of possession, particularly in constructive possession cases.</p>
          </div>
