...
export const metadata: Metadata = {
  title: "Marttila v. City of Lynchburg | Virginia Disorderly Conduct Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2013) — Whether the city's disorderly conduct ordinance was unconstitutionally vague as.... D.J. Rivera defends Disorderly Conduct cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Marttila v. City of Lynchburg</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Disorderly Conduct Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Marttila v. City of Lynchburg</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the city's disorderly conduct ordinance was unconstitutionally vague as applied to the defendant's conduct.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court struck down the disorderly conduct ordinance as applied, finding that it was unconstitutionally vague because it did not give fair notice of what conduct was prohibited. The court held that a disorderly conduct ordinance must be sufficiently specific to allow a person of ordinary intelligence to understand what conduct is prohibited.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">Disorderly conduct statutes and ordinances are frequently challenged as unconstitutionally vague or overbroad. D.J. Rivera challenges disorderly conduct charges on constitutional grounds — arguing that the statute or ordinance is vague, overbroad, or as applied to the defendant's specific conduct, unconstitutional.</p>
          </div>
