...
export const metadata: Metadata = {
  title: "Woods v. Commonwealth | Virginia Homicide & Murder Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2015) — Whether the defendant's statement to police was properly admitted where the defe.... D.J. Rivera defends Homicide & Murder cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Woods v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Homicide & Murder Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Woods v. Commonwealth</h1>
