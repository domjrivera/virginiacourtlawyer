...
export const metadata: Metadata = {
  title: "Dosky v. Commonwealth | Virginia Homicide & Murder Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2009) — Whether the evidence was sufficient to prove premeditation for first-degree murd.... D.J. Rivera defends Homicide & Murder cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Dosky v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">Homicide & Murder Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Dosky v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the evidence was sufficient to prove premeditation for first-degree murder.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court reversed the first-degree murder conviction, finding that the evidence was insufficient to prove premeditation. The court held that premeditation requires proof that the defendant formed the intent to kill before the act, and that the brief time between the formation of intent and the act — while legally sufficient — was not proven beyond a reasonable doubt on the facts of this case.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">The distinction between first-degree murder (premeditated) and second-degree murder (unpremeditated) is critical — first-degree murder carries a mandatory minimum of 20 years, while second-degree murder carries 5–40 years. D.J. Rivera challenges premeditation in every first-degree murder case, arguing that the evidence supports at most second-degree murder or manslaughter.</p>
          </div>
