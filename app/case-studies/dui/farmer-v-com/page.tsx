...
export const metadata: Metadata = {
  title: "Farmer v. Commonwealth | Virginia DUI / DWI Defense – D.J. Rivera, Esq.",
  description: "Virginia Court of Appeals (2007) — Whether the traffic stop leading to the DUI arrest was constitutionally valid un.... D.J. Rivera defends DUI / DWI cases in Richmond and Northern Virginia.",
};
      ...
      <section className="bg-navy text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <span className="text-slate-600">›</span>
            <span className="text-gold text-sm">Farmer v. Commonwealth</span>
          </div>
          <p className="text-gold font-medium uppercase tracking-widest mb-3 text-sm">DUI / DWI Case Study</p>
          <h1 className="text-4xl font-serif leading-tight mb-4">Farmer v. Commonwealth</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-10">
          <div className="bg-slate-50 rounded-2xl p-8 border-l-4 border-navy">
            ...
            <p className="text-slate-700 leading-relaxed">Whether the traffic stop leading to the DUI arrest was constitutionally valid under the Fourth Amendment.</p>
          </div>

          <div>
            <h2 className="text-2xl font-serif text-navy mb-4">Court Holding</h2>
            <p className="text-slate-700 leading-relaxed text-lg">The court affirmed the conviction, holding that the officer had reasonable articulable suspicion to initiate the traffic stop based on observed traffic violations. The court found that the breathalyzer results were properly admitted and that the conviction was supported by sufficient evidence.</p>
          </div>

          <div className="bg-navy text-white rounded-2xl p-8">
            <h2 className="text-2xl font-serif mb-4 text-gold">Defense Takeaway</h2>
            <p className="text-slate-200 leading-relaxed">The validity of the initial traffic stop is the first line of defense in every DUI case. If the stop was unlawful — based on a hunch rather than reasonable articulable suspicion of a traffic violation or criminal activity — all evidence obtained as a result of the stop (including breathalyzer results) can be suppressed. D.J. Rivera scrutinizes every aspect of the stop in DUI cases.</p>
          </div>
